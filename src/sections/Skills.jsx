...
export const Skills = () => {
  return (
    <section className="skills-content relative container max-w-(--wrapper-sm) m-auto p-6 mt-24 sm:mt-48">
      ...
      <div className="skill-group mt-12 intersect:motion-preset-slide-right motion-duration-2000">
      ...
      <div className="skill-group mt-12 intersect:motion-preset-slide-left motion-duration-2000">
