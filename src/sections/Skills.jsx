...
export const Skills = () => {
  return (
    <section className="skills-content relative container max-w-(--wrapper-sm) m-auto p-6 mt-24 sm:mt-48">
      <h2 className="text-2xl font-semibold intersect:motion-preset-slide-up motion-duration-2000 motion-delay-300">
      ...
      <div className="skill-group mt-12 intersect:motion-preset-slide-up motion-duration-2000 motion-delay-300">
