...
export const Projects = () => {
  return (
    <section className="skills-content relative max-w-(--wrapper-sm) m-auto p-6 mt-24 sm:mt-48">
      <h2 className="text-2xl font-semibold intersect:motion-preset-slide-right motion-duration-1000 motion-delay-300">
      ...
      <ul className="project-list">
        {projectsData.map((project, i) => (
          <li className="project-item mt-12" key={i}>
            <article
              className={`project-teaser ${(i + 1) % 2 === 0 ? "reverse intersect:motion-preset-slide-right" : "intersect:motion-preset-slide-left"} motion-duration-1000 motion-delay-500`}
            >
              {" "}
              <a
