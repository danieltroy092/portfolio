export const About = () => {
  return (
    <section className="profile-content relative p-6 max-w-(--wrapper-base) m-auto">
      <h2 className="py-6 text-2xl font-semibold intersect:motion-preset-slide-right motion-duration-1000 motion-delay-300">
      ...
      <div className="profile-text flex flex-col-reverse items-center gap-10 container sm:flex-row sm:items-start">
        <div className="sm:basis-[50%] intersect:motion-preset-slide-right motion-duration-1000 motion-delay-300">
          <p></p>
        ...
        <div className="relative sm:basis-[50%] intersect:motion-preset-slide-left motion-duration-1000 motion-delay-300">
          <span
