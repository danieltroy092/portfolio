  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="hero-content relative container m-auto p-6 sm:max-w-[70vw]">
        <h1>
          <span className="block md:text-lg font-mono">Hi, my name is</span>
          <span className="block text-5xl md:text-6xl mt-4 font-calibre-bold gradient-text">
            Daniel Troy Ong.
          </span>
          <span className="block text-5xl md:text-6xl mt-2 font-calibre-bold gradient-text text-balance">
