...
export const Experience = () => {
  return (
    <section className="about-content container relative max-w-(--wrapper-base) m-auto px-6 mt-24 sm:mt-48">
      <h2 className="text-2xl font-semibold intersect:motion-preset-slide-right intersect:motion-opacity-in motion-duration-2000 motion-delay-700">
      ...
      <div className="mt-6 intersect:motion-preset-slide-right intersect:motion-opacity-in motion-duration-1000 motion-delay-500">
