    ...
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto relative px-6 z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span
            id="contact"
            className="text-secondary-foreground font-mono tracking-tight intersect:motion-preset-slide-up motion-duration-2000 motion-delay-400"
          >
            05. What's Next?
          </span>
          <h2 className="font-calibre-bold text-white mt-4 text-5xl intersect:motion-preset-slide-up motion-duration-2000 motion-delay-600">
            Get In Touch
          </h2>

          <p className="text-primary lg:w-1/2 mt-4 m-auto text-pretty intersect:motion-preset-slide-up motion-duration-2000 motion-delay-800">
            Have a project in mind? I'd love to hear about it. Drop me a message
            and let's discuss how we can work together.
          </p>
        </div>

        <div className="max-w-lg mx-auto intersect:motion-preset-slide-right motion-duration-2000 motion-delay-200">
